...
<body>
    ...
    <main>
        ...
        <div class="Encapsulated-Page">
            ...
            <p> La presente Política de Privacidad describe cómo Market Mallorca recopila, utiliza y protege la información obtenida a través de su sitio web https://www.marketmallorca.com. Nos comprometemos firmemente a proteger la privacidad de nuestros usuarios y a manejar su información personal de manera responsable, transparente y segura, en cumplimiento de la legislación colombiana vigente en materia de protección de datos personales. 
            </p>
            ...
            <section>
                ...
                <ul>
                    ...
                    <li> Páginas visitadas dentro de nuestro sitio y la secuencia de navegación. </li>
                    <li> Tiempo de permanencia en las diferentes secciones. </li>
                    <li> Dispositivos utilizados para acceder al sitio. </li>
                    <li> Fuentes de referencia.</li>
                </ul>
            ...
            <section>
                ...
                <p> Nuestro sitio web facilita la comunicación directa con nuestro equipo a través de enlaces a servicios de mensajería como WhatsApp. Al hacer clic en estos enlaces, usted será dirigido a la aplicación o versión web de WhatsApp, la cual es operada por un tercero (Meta Platforms, Inc.). Tenga en cuenta que, una vez fuera de nuestro sitio web, la recopilación, uso y protección de su información personal estarán regidos por la Política de Privacidad y los Términos de Servicio de dicho tercero. No tenemos control sobre el contenido, las políticas o las prácticas de servicios externos y no asumimos responsabilidad por ellos. Le recomendamos revisar las políticas de privacidad de cada servicio que utilice fuera de nuestro sitio web. 
                </p>
            ...
            <section>
                ...
                <p> Nuestro Sitio utiliza cookies y otras tecnologías similares (como píxeles o web beacons)
                para recopilar datos de uso y analíticas. Las cookies son pequeños archivos de texto que se almacenan en tu
                navegador cuando visitas nuestro sitio web. Utilizamos cookies para: 
                </p>

                <ul>
                    <li> Recordar tus preferencias y configuraciones.</li>

                    <li> Analizar el tráfico del sitio y comprender cómo los usuarios interactúan con él. </li>

                    <li> Mejorar la funcionalidad y el rendimiento del Sitio. Puedes gestionar tus preferencias de cookies a través de la configuración de tu navegador. Ten en cuenta que deshabilitar ciertas cookies puede afectar la funcionalidad del Sitio. 
                    </li>
                </ul>
            ...
            <section>
                ...
                <p> De conformidad con la legislación colombiana vigente en materia de protección de datos personales (Ley 1581
                de 2012 y sus decretos reglamentarios), como titular de tus datos personales, tienes los siguientes
                derechos: 
                </p>
                ...
                <p> Para ejercer cualquiera de estos derechos, puedes ponerte en contacto con nosotros a través de los canales indicados en la sección de Contacto de esta política. Atenderemos tu solicitud en los términos y plazos establecidos por la ley. 
                </p>
            ...
            <section>
                ...
                <p> Market Mallorca se reserva el derecho de actualizar o modificar esta Política de Privacidad en cualquier momento. Cualquier cambio será efectivo inmediatamente después de su publicación en esta página. Te recomendamos revisar periódicamente esta política para estar siempre informado sobre cómo protegemos tu información y las prácticas de privacidad que mantenemos. 
                </p>
