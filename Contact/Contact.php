        ...
        <section class="Encapsulated-Small">
            ...
            <section class="Section-Contacts">
                ...
                <ul> 
                    ...
                    <li class="Mail"> <strong> Correo: </strong> <a href="mailto:cardonaarizasas@gmail.com" aria-label="Enviar correo a cardonaarizasas@gmail.com"> cardonaarizasas@gmail.com </a> </li> 

                    <li class="Number"> <strong> Numero principal: </strong> <a href="tel:+573001010014"> 3001010014 </a> </li>

                    <li class="Number"> <strong> Numero de respaldo: </strong> <a href="tel:+57300411147"> 300411147 </a> </li>
